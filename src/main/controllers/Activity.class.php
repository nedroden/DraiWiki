...
use DraiWiki\src\main\models\{AppHeader, Activity as Model};

class Activity extends AppHeader {
    ...
    public function execute() : void {
        ...
        $this->_model->loadUpdates();

        $this->_view = Registry::get('gui')->parseAndGet('activity', $this->_model->prepareData(), false);
    }
